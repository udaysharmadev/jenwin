...
const bentoItems = [
  {
    ...
    label: "Speed",
    title: "< 7 day MVPs",
    description: "From validated idea to live product in under 7 days. We've built and shipped 12+ MVPs fast without cutting corners on architecture.",
    stat: "12+",
  ...
  },
  {
    ...
    description: "Edge-deployed, CDN-optimized. Your users get fast load times no matter where they are.",
    stat: "<100ms",
  ...
  },
  {
    ...
    description: "Not AI for the sake of it. We build AI features that reduce real work, automate the boring stuff, and give your product an actual edge.",
    stat: "GPT-4o / Gemini",
  ...
  },
  {
    ...
    label: "Performance",
    title: "Lighthouse 95+",
    description: "Performance isn't optional. It's baked into every build from day one.",
    stat: "95+",
