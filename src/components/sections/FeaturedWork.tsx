...
const projects = [
  {
    ...
    title: "KixCures",
    url: "kixcures.com",
    outcome: "D2C sneaker cleaning brand with a store that speaks directly to the sneakerhead community.",
    tags: ["Shopify", "Custom Theme", "D2C"],
    accent: "#0ea5e9",
    num: "01",
  },
  {
    ...
    title: "VisaOvisa",
    url: "visaovisa.com",
    outcome: "Visa and Gulf job platform with 34K+ clients, WhatsApp lead gen, and a job application system.",
    tags: ["Node.js", "WhatsApp", "Static Site"],
    accent: "#DC143C",
    num: "02",
  },
  {
    ...
    outcome: "ISO 9001 certified security services company with a site that generates qualified B2B leads.",
