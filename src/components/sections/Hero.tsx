...
export default function Hero() {
  return (
    ...
    >
      ...
      {/* Background ruby glow (top-left) */}
      <div
        className="absolute top-0 left-1/4 w-[700px] h-[600px] pointer-events-none"
        style={{
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-32 lg:py-40 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-4 items-center">
          ...
          <div className="max-w-xl">
            ...
            >
              Built to perform.{" "}
              <span className="text-ruby-gradient">Designed</span>{" "}
              to last.
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-lg lg:text-xl text-[#888888] max-w-xl leading-relaxed mb-10"
            >
              We blend engineering precision, product thinking, and design discipline to build digital experiences that feel sharp, scale clean, and ship on time — for Indian founders building what&apos;s next.
            </motion.p>
        ...
        <motion.div
          ...
          className="mt-16 lg:mt-20 grid grid-cols-2 lg:grid-cols-4 gap-px bg-[#1a1a1a] rounded-sm overflow-hidden border border-[#1a1a1a]"
        >
          {[
            { value: "50+", label: "Projects Delivered" },
            { value: "< 8 wk", label: "Avg. MVP Timeline" },
            { value: "100%", label: "On-time Delivery" },
            { value: "India", label: "Based & Building" },
          ].map((stat) => (
            <div
              key={stat.label}
